...
const LikeInPost = ({ likes, dislikes, usersLiked, usersDisliked, id }) => {
	...
	}, [likes, dislikes, usersDisliked, usersLiked]);
	...
	return (
		<div className="likeBar">
			<div className="likes">
				<i className={usersLikedArray.includes(parsedStorage.userId) ? "colorLike" : "like"} onClick={likePost}>
					<BiLike />
				</i>
			...
			<div className="likes">
				<i
					className={usersDislikedArray.includes(parsedStorage.userId) ? "colorDislike" : "like"}
					onClick={dislikePost}
				>
					<BiDislike />
				</i>
